...
class Conection {
  static async conect(user: string) {
    ...
    let repos = await fetch(
      `https://api.github.com/users/${user}/repos?per_page=5&sort='created: asc'&client_id=7c66f7eced0d99fa8e4c&client_secret=da05d6bba9168e2a3570693e09d1e5b2cb3b9655`
    );
